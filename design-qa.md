...
- Source visual truth: `/var/folders/mh/rxmkm5jd2s1d952s608rwwy40000gn/T/codex-clipboard-973e97d5-51fe-4424-8151-0bdaa135024f.png`
...
- Source pixels: 2940 × 1912; normalized as a 2× capture to 1470 × 956 CSS px
...
The source and desktop implementation were opened together after density normalization. The contact container, 1024 px content rail, footer boundary, two CTA proportions, secondary links, footer navigation, launcher label, and bottom-right assistant trigger align with the reference. The user-requested rounded corners intentionally supersede the square corners visible in the original screenshot. The black strip at the top of the source belongs to the preceding page region and is outside the contact component. The implementation screenshot contains the development-only Next.js indicator at bottom left; it is not included in production.

**Focused region comparison evidence**

- Contact controls: the 256 × 92 px primary CTA, 312 × 92 px booking CTA, 12 px inter-card gap, 12 px corner radius, icon placement, and secondary-action baseline were checked at native CSS scale.
...
- Copy and content: source contact copy is preserved. Chat labels remain concise and task-specific.
